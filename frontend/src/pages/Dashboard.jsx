...
const Dashboard = () => {
  ...
  return (
    ...
    >
      ...
      {/* Available Balance */}
      <div
        className={`w-full rounded-lg p-6 flex flex-col md:flex-row justify-between items-start md:items-center relative overflow-hidden ${
      ...
      >
        <div className="space-y-12">
          ...
          <div className="flex space-x-3">
            <button
              className="w-10 h-10 rounded bg-opacity-20 flex items-center justify-center text-black text-xl border border-white hover:bg-white hover:text-black transition-colors"
        ...
        <div className="flex flex-col gap-6">
          ...
          <div
            className={`flex items-center p-5 rounded-lg ${
              darkMode ? "bg-[#2c3a5a]" : "bg-blue-200"
            }`}
          >
            <div
          ...
          >
            <div
              className={`w-12 h-12 rounded-full flex items-center justify-center ${
                darkMode ? "bg-sky-500" : "bg-sky-600"
              } text-white text-lg font-bold`}
            >
              <Tag size={20} />
            </div>
                  ...
                  <tr
                    ...
                    className={`${
                      darkMode
                        ...
                        : "border-b border-gray-300 text-gray-800"
                    }`}
                  >
