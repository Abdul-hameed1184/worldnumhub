      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start justify-between gap-10">
        ...
        <div className="w-full  text-center md:text-left">
          {/* <h1 className="text-2xl md:text-3xl font-semibold text-gray-800 mb-3">
           ...
           <TypingEffect />
          <p className="text-gray-500 text-[1.3rem] max-w-md font-medium">
            We Provide Virtual Numbers and OTP to Prevent your Identity and
            Secure your Privacy
          </p>
          ...
          <div className="flex flex-row sm:justify-start justify-center gap-4 mt-6">
            <button
              className="bg-yellow-400 hover:bg-yellow-500 text-sm font-medium text-white px-6 py-2 rounded-full flex items-center transition-colors gap-3"
